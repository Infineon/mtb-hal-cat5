...
#if (CYHAL_DRIVER_AVAILABLE_SDIO_DEV)
#if !defined(CYHAL_SDIO_MAX_FRAME_LENGTH)
/** Maximum frame length for SDIO */
#define SDIO_F2_FRAME_MAX_LENGTH                        (0x800)
#elif defined (CYHAL_SDIO_MAX_FRAME_LENGTH) && (CYHAL_SDIO_MAX_FRAME_LENGTH <= 0x800)
/** Maximum frame length for SDIO */
#define SDIO_F2_FRAME_MAX_LENGTH                        (CYHAL_SDIO_MAX_FRAME_LENGTH)
#else
#error CYHAL_SDIO_MAX_FRAME_LENGTH must be lower or equal 2048.
#endif
