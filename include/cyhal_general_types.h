...
enum cyhal_rslt_module_chip
{
    ...
    CYHAL_RSLT_MODULE_I3C           = (0x0B),  //!< An error occurred in I3C module
    ...
    CYHAL_RSLT_MODULE_LPTIMER       = (0x10),  //!< An error occurred in LPTimer module
    CYHAL_RSLT_MODULE_NVM           = (0x11),  //!< An error occurred in NVM module
    CYHAL_RSLT_MODULE_OPAMP         = (0x12),  //!< An error occurred in OpAmp module
    CYHAL_RSLT_MODULE_PDMPCM        = (0x13),  //!< An error occurred in PDM/PCM module
    CYHAL_RSLT_MODULE_PWM           = (0x14),  //!< An error occurred in PWM module
    CYHAL_RSLT_MODULE_QSPI          = (0x15),  //!< An error occurred in QSPI module
    CYHAL_RSLT_MODULE_QUADDEC       = (0x16),  //!< An error occurred in Quadrature Decoder module
    CYHAL_RSLT_MODULE_RTC           = (0x17),  //!< An error occurred in RTC module
    CYHAL_RSLT_MODULE_SDHC          = (0x18),  //!< An error occurred in SDHC module
    CYHAL_RSLT_MODULE_SDIO          = (0x19),  //!< An error occurred in SDIO module
    CYHAL_RSLT_MODULE_SPI           = (0x1A),  //!< An error occurred in SPI module
    CYHAL_RSLT_MODULE_SYSPM         = (0x1B),  //!< An error occurred in SysPM module
    CYHAL_RSLT_MODULE_SYSTEM        = (0x1C),  //!< An error occurred in System module
    CYHAL_RSLT_MODULE_TDM           = (0x1D),  //!< An error occurred in Timer module
    CYHAL_RSLT_MODULE_TIMER         = (0x1E),  //!< An error occurred in Timer module
    CYHAL_RSLT_MODULE_TRNG          = (0x1F),  //!< An error occurred in RNG module
    CYHAL_RSLT_MODULE_UART          = (0x20),  //!< An error occurred in UART module
    CYHAL_RSLT_MODULE_USB           = (0x21),  //!< An error occurred in USB module
    CYHAL_RSLT_MODULE_WDT           = (0x22),  //!< An error occurred in WDT module
    // Implementation specific section
    CYHAL_RSLT_MODULE_IMPL_TCPWM    = (0x23),  //!< An error occurred in TCPWM module (TCPWM based drivers are: Timer, PWM, Quadrature Decoder)
    CYHAL_RSLT_MODULE_IMPL_SCB      = (0x24),  //!< An error occurred in SCB module (SCB based drivers are: I2C, SPI, UART)
    CYHAL_RSLT_MODULE_T2TIMER       = (0x25),  //!< An error occurred in T2Timer module
    CYHAL_RSLT_MODULE_ETHERNET      = (0x26),  //!< An error occurred in Ethernet module
    CYHAL_RSLT_MODULE_OTP           = (0x27),  //!< An error occurred in OTP module
};
