...
#define CYHAL_DRIVER_AVAILABLE_I3C          (0)
...
#define CYHAL_DRIVER_AVAILABLE_PDMPCM       (1)
#if defined (CYW55500)
#define CYHAL_DRIVER_AVAILABLE_SDIO         (0)
#elif defined (CYW55900)
...
#define CYHAL_DRIVER_AVAILABLE_SDIO_DEV     (CYHAL_DRIVER_AVAILABLE_SDIO)
...
typedef enum
{
    ...
    CYHAL_RSC_PDMPCM,    /*!< PCM/PDM communications block */
    CYHAL_RSC_RTC,       /*!< Real time clock */
    CYHAL_RSC_SCB,       /*!< Serial Communications Block */
    CYHAL_RSC_SDIO,      /*!< Seecure Digital Input Output (device) */
